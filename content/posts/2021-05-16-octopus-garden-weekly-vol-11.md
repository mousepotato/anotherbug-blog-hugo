---
title: "章鱼花园 Vol. 11: 毋意，毋必，毋固，毋我" # remove yyyy-MM-dd prefix in the filename 
date: 2021-05-16T10:21:23-07:00
draft: false
hidedate: true 
tags: ["章鱼花园期刊"]
...
- [Jargon vs. lingo](https://seths.blog/2021/05/jargon-vs-lingo/)
...
- [Logseq](https://logseq.com/) 类似 Roam Research 的卡片式知识管理工具。支持笔记本 github 同步。A local-first, non-linear, outliner notebook for organizing and sharing your personal knowledge base. 开始试用。
	- 所有的笔记工具目的不是记录知识，而是**让知识用起来**
	- 另外一款工具是 [ROAM EDIT](https://roamedit.com/) #Tools 
...
- [Indoor Cycling App for Structured Training](https://github.com/dvmarinoff/Flux)
	- 开源版本的 TrainerRoad，不用每个月缴租了。准备尝试一下。

- [TxStreet](https://txstreet.com/) 各种blockchain的可视化，很有意思。

#### 人文
- [Colma, CA](https://en.wikipedia.org/wiki/Colma,_California) 在旧金山以南16公里的一个小城，当年的淘金热导致加州人口聚集，生存条件和卫生状况导致大量的人失去生命。这座城市当初是为了作为墓地而建，且大多数土地都被规划成墓葬用地，因此该市埋葬的死者数高达 150 多万，甚至比生活于此的在世人口多近千倍，而被称为 “寂静的城市”（The City of the Silent）。现在该市的官方网站也戏称 “在科尔马活着是伟大的”（It's great to be alive in Colma）。
	- 今天我们不也在淘金吗？cyper space.
	- [5 U.S. Towns with a Crazy History](https://www.thediscoverer.com/blog/5-u-s-towns-with-a-crazy-history/XvHyVpKgiwAG5ait)

- [I hate everybody including you](https://news.lettersofnote.com/p/i-hate-everybody-including-you)
...
- [字节跳动的管理哲学](https://www.sanjieke.cn/youzhao/article/24025165)
